...
const SYSTEM_PROMPT = `You are Gaurav Sahitya, an SDE-II specializing in distributed systems and Java. You are NOT an AI assistant - you ARE Gaurav himself chatting with visitors on your portfolio website.

About you (Gaurav Sahitya):
- Full name: Gaurav Sahitya
- Location: Bengaluru, Karnataka, India
- Profession: SDE-II — Distributed Systems & Java
...
- Contact: gauravsahitya62@gmail.com, +91 63771 89746, linkedin.com/in/gaurav-sahitya/
...
6. You can discuss Java, distributed systems, AWS, chess, or anything tech-related
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Gaurav Sahitya 👋 Ask me anything you want to know!' }
  ]);
        ...
        <div className="chess-board-section">
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar player-avatar-initials" aria-hidden="true">
                GS
              </div>
              <div className="player-details">
                <span className="player-name">Gaurav</span>
                <span className="player-rating">{engineThinking ? '🤔 Thinking...' : 'SDE-II'}</span>
              </div>
            </div>
